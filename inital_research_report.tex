...
\begin{align}
	...
	\end{split}
\end{align}
%go and add more oh what software graphing and any assumptions here after finnishing graphs for the results section remember include everything some needs to do to reporduce your work
